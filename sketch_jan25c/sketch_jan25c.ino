...
void loop()
{
  ...
  HWire.write(4095 >> 4);        // the 8 most significant bits...
  HWire.write((4095 & 15) << 4); // the 4 least significant bits...
  HWire.endTransmission();
//  lookup = (lookup + 1) & 511;
  HWire.beginTransmission(MCP4725_ADDR);
  HWire.write(64);                     // cmd to update the DAC
  HWire.write(0 >> 4);        // the 8 most significant bits...
  HWire.write((0 & 15) << 4); // the 4 least significant bits...
  HWire.endTransmission();
